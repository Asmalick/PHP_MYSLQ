...
-->
    ...
    ?>           </ul>
                <ul class="icons">
                    ...
                    <li><a href="https://github.com/Asmalick" class="icon brands fa-github"><span class="label">GitHub</span></a></li>
                </ul>
            </nav>
        <?php
    }
        ...
        ?>
            ...
            <div id="main">
                ...
                <section class="post">
                    ...
                    <div class="image main"><img src="image/<?php echo $image; ?>.jpg" alt="" /></div>
                ...
                <section class="split contact">
                    ...
                    <section>
                        ...
                        <ul class="icons alt">
                            ...
                            <li><a href="https://github.com/Asmalick" class="icon brands alt fa-github"><span class="label">GitHub</span></a></li>
                        </ul>
                    </section>
                </section>
            </footer>
